            ...
            <section style={{ marginBottom: 40 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                    {[
                        ...
                        <div key={label} style={{ background: "#2a2a4a", borderRadius: 8, padding: "14px 16px" }}>
...
function MemberCard({ name, email, role }: { name: string; email: string; role: string }) {
    return (
        <div style={{ background: "#2a2a4a", borderRadius: 8, padding: "14px 16px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
            <div>
